...
mavlink10.HEADING_TYPE_DEFAULT = 2 // 
mavlink10.HEADING_TYPE_ENUM_END = 3 // 
...
mavlink10.MAV_CMD_DO_SET_ACTUATOR = 187 // Sets actuators (e.g. servos) to a desired value. The actuator numbers
                        ...
                        // parameter).
mavlink10.MAV_CMD_DO_RETURN_PATH_START = 188 // Mission item to specify the start of a failsafe/landing return-path
                        ...
                        // ignored.
mavlink10.MAV_CMD_DO_LAND_START = 189 // Mission item to mark the start of a mission landing pattern, or a
...
mavlink10.MAV_CMD_DO_SET_CAM_TRIGG_DIST = 206 // Mission command to set camera trigger distance for this flight. The
                        ...
                        // camera.
mavlink10.MAV_CMD_DO_FENCE_ENABLE = 207 //            Enable the geofence.           This can be used in a
...
mavlink10.MAV_CMD_DO_SET_STANDARD_MODE = 262 // Enable the specified standard MAVLink mode.           If the specified
...
mavlink10.MAV_CMD_ILLUMINATOR_ON_OFF = 405 // Turns illuminators ON/OFF. An illuminator is a light source that is
                        ...
                        // light).
mavlink10.MAV_CMD_DO_ILLUMINATOR_CONFIGURE = 406 // Configures illuminator settings. An illuminator is a light source that
...
mavlink10.MAV_CMD_SET_STORAGE_USAGE = 533 // Set that a particular storage is the preferred location for saving
                        ...
                        // MAV_RESULT_DENIED.
mavlink10.MAV_CMD_SET_CAMERA_SOURCE = 534 // Set camera source. Changes the camera's active sources on cameras with
...
mavlink10.MAV_CMD_IMAGE_START_CAPTURE = 2000 // Start image capture sequence. CAMERA_IMAGE_CAPTURED must be emitted
                        ...
                        // channels.
mavlink10.MAV_CMD_IMAGE_STOP_CAPTURE = 2001 // Stop image capture sequence.            Param1 (id) may be used to
...
mavlink10.MAV_CMD_UAVCAN_GET_NODE_INFO = 5200 // Commands the vehicle to respond with a sequence of messages
                        ...
                        // messages.
mavlink10.MAV_CMD_DO_SET_SAFETY_SWITCH_STATE = 5300 // Change state of safety switch.
...
mavlink10.MAV_CMD_LOWEHEISER_SET_STATE = 10151 // Set Loweheiser desired states
...
mavlink10.MAV_CMD_SET_HAGL = 43005 // Provide a value for height above ground level. This can be used for
                        // things like fixed wing and VTOL landing.
mavlink10.MAV_CMD_ENUM_END = 43006 // 
...
// SECURE_COMMAND_OP
mavlink10.SECURE_COMMAND_GET_SESSION_KEY = 0 // Get an 8 byte session key which is used for remote secure updates
...
mavlink10.SECURE_COMMAND_GET_REMOTEID_SESSION_KEY = 1 // Get an 8 byte session key which is used for remote secure updates
                        ...
                        // run.
mavlink10.SECURE_COMMAND_REMOVE_PUBLIC_KEYS = 2 // Remove range of public keys from the bootloader. Command data consists
...
mavlink10.SECURE_COMMAND_GET_PUBLIC_KEYS = 3 // Get current public keys from the bootloader. Command data consists of
...
mavlink10.SECURE_COMMAND_SET_PUBLIC_KEYS = 4 // Set current public keys in the bootloader. Data consists of a one byte
                        ...
                        // remain unchanged.
mavlink10.SECURE_COMMAND_GET_REMOTEID_CONFIG = 5 // Get config data for remote ID module. This command should be sent to
...
mavlink10.SECURE_COMMAND_SET_REMOTEID_CONFIG = 6 // Set config data for remote ID module. This command should be sent to
                        // the component ID of the flight controller
                        // which will forward it to the RemoteID
                        // module either over mavlink or DroneCAN.
                        // Data format is specific to the RemoteID
                        // implementation, see RemoteID firmware
                        // documentation for details.
mavlink10.SECURE_COMMAND_FLASH_BOOTLOADER = 7 // Flash bootloader from local storage. Data is the filename to use for
                        // the bootloader. This is intended to be used
                        // with MAVFtp to upload a new bootloader to a
                        // microSD before flashing.
mavlink10.SECURE_COMMAND_OP_ENUM_END = 8 // 
...
mavlink10.ALT_FRAME_VALID = 4 // True if the following altitude frame value is valid.
mavlink10.ALT_FRAME = 24 // 2 bit value representing altitude frame. 0: absolute, 1: relative
                        // home, 2: relative origin, 3: relative
                        // terrain
mavlink10.RALLY_FLAGS_ENUM_END = 25 // 
...
mavlink10.EKF_GPS_GLITCHING = 32768 // Set if EKF believes the GPS input data is faulty.
mavlink10.EKF_STATUS_FLAGS_ENUM_END = 32769 // 
...
// MAV_FRAME
mavlink10.MAV_FRAME_GLOBAL = 0 // Global (WGS84) coordinate frame + altitude relative to mean sea level
                        // (MSL).
...
mavlink10.MAV_FRAME_LOCAL_ENU = 4 // ENU local tangent frame (x: East, y: North, z: Up) with origin fixed
                        // relative to earth.
mavlink10.MAV_FRAME_GLOBAL_INT = 5 // Global (WGS84) coordinate frame (scaled) + altitude relative to mean
                        // sea level (MSL).
...
mavlink10.MAV_FRAME_GLOBAL_TERRAIN_ALT = 10 // Global (WGS84) coordinate frame with AGL altitude (altitude at ground
                        // level).
mavlink10.MAV_FRAME_GLOBAL_TERRAIN_ALT_INT = 11 // Global (WGS84) coordinate frame (scaled) with AGL altitude (altitude
                        // at ground level).
...
// FENCE_TYPE
mavlink10.FENCE_TYPE_ALL = 0 // All fence types
mavlink10.FENCE_TYPE_ALT_MAX = 1 // Maximum altitude fence
mavlink10.FENCE_TYPE_CIRCLE = 2 // Circle fence
mavlink10.FENCE_TYPE_POLYGON = 4 // Polygon fence
mavlink10.FENCE_TYPE_ALT_MIN = 8 // Minimum altitude fence
mavlink10.FENCE_TYPE_ENUM_END = 9 // 
...
mavlink10.ORBIT_YAW_BEHAVIOUR_UNCHANGED = 5 // Vehicle uses current yaw behaviour (unchanged). The vehicle-default
                        // yaw behaviour is used if this value is
                        // specified when orbit is first commanded.
mavlink10.ORBIT_YAW_BEHAVIOUR_ENUM_END = 6 // 
...
mavlink10.MAV_PROTOCOL_CAPABILITY_COMPONENT_IMPLEMENTS_GIMBAL_MANAGER = 262144 // This component implements/is a gimbal manager. This means the
                        // GIMBAL_MANAGER_INFORMATION, and other
                        // messages can be requested.
mavlink10.MAV_PROTOCOL_CAPABILITY_COMPONENT_ACCEPTS_GCS_CONTROL = 524288 // Component supports locking control to a particular GCS independent of
                        // its system (via
                        // MAV_CMD_REQUEST_OPERATOR_CONTROL).
mavlink10.MAV_PROTOCOL_CAPABILITY_ENUM_END = 524289 // 
...
// MAV_FUEL_TYPE
mavlink10.MAV_FUEL_TYPE_UNKNOWN = 0 // Not specified. Fuel levels are normalized (i.e. maximum is 1, and
                        // other levels are relative to 1).
mavlink10.MAV_FUEL_TYPE_LIQUID = 1 // A generic liquid fuel. Fuel levels are in millilitres (ml). Fuel rates
                        // are in millilitres/second.
mavlink10.MAV_FUEL_TYPE_GAS = 2 // A gas tank. Fuel levels are in kilo-Pascal (kPa), and flow rates are
                        // in milliliters per second (ml/s).
mavlink10.MAV_FUEL_TYPE_ENUM_END = 3 // 
...
mavlink10.CAMERA_CAP_FLAGS_HAS_THERMAL_RANGE = 4096 // Camera supports absolute thermal range (request CAMERA_THERMAL_RANGE
                        // with MAV_CMD_REQUEST_MESSAGE).
mavlink10.CAMERA_CAP_FLAGS_ENUM_END = 4097 // 
...
mavlink10.VIDEO_STREAM_STATUS_FLAGS_THERMAL_RANGE_ENABLED = 4 // Stream can report absolute thermal range (see CAMERA_THERMAL_RANGE).
mavlink10.VIDEO_STREAM_STATUS_FLAGS_ENUM_END = 5 // 
...
mavlink10.VIDEO_STREAM_TYPE_MPEG_TS = 3 // Stream is MPEG TS (URI gives the port number)
mavlink10.VIDEO_STREAM_TYPE_ENUM_END = 4 // 

// VIDEO_STREAM_ENCODING
mavlink10.VIDEO_STREAM_ENCODING_UNKNOWN = 0 // Stream encoding is unknown
mavlink10.VIDEO_STREAM_ENCODING_H264 = 1 // Stream encoding is H.264
mavlink10.VIDEO_STREAM_ENCODING_H265 = 2 // Stream encoding is H.265
mavlink10.VIDEO_STREAM_ENCODING_ENUM_END = 3 // 
...
// CAMERA_SOURCE
mavlink10.CAMERA_SOURCE_DEFAULT = 0 // Default camera source.
mavlink10.CAMERA_SOURCE_RGB = 1 // RGB camera source.
mavlink10.CAMERA_SOURCE_IR = 2 // IR camera source.
mavlink10.CAMERA_SOURCE_NDVI = 3 // NDVI camera source.
mavlink10.CAMERA_SOURCE_ENUM_END = 4 // 
...
// RC_TYPE
mavlink10.RC_TYPE_SPEKTRUM = 0 // Spektrum
mavlink10.RC_TYPE_CRSF = 1 // CRSF
mavlink10.RC_TYPE_ENUM_END = 2 // 

// RC_SUB_TYPE
mavlink10.RC_SUB_TYPE_SPEKTRUM_DSM2 = 0 // Spektrum DSM2
mavlink10.RC_SUB_TYPE_SPEKTRUM_DSMX = 1 // Spektrum DSMX
mavlink10.RC_SUB_TYPE_SPEKTRUM_DSMX8 = 2 // Spektrum DSMX8
mavlink10.RC_SUB_TYPE_ENUM_END = 3 // 
...
mavlink10.MAV_TUNNEL_PAYLOAD_TYPE_MODALAI_REMOTE_OSD = 210 // Registered for ModalAI remote OSD protocol.
mavlink10.MAV_TUNNEL_PAYLOAD_TYPE_MODALAI_ESC_UART_PASSTHRU = 211 // Registered for ModalAI ESC UART passthru protocol.
mavlink10.MAV_TUNNEL_PAYLOAD_TYPE_MODALAI_IO_UART_PASSTHRU = 212 // Registered for ModalAI vendor use.
mavlink10.MAV_TUNNEL_PAYLOAD_TYPE_ENUM_END = 213 // 
...
mavlink10.HIGHRES_IMU_UPDATED_FLAGS_ENUM_END = 4097 // 
...
// SAFETY_SWITCH_STATE
mavlink10.SAFETY_SWITCH_STATE_SAFE = 0 // Safety switch is engaged and vehicle should be safe to approach.
mavlink10.SAFETY_SWITCH_STATE_DANGEROUS = 1 // Safety switch is NOT engaged and motors, propellers and other
                        // actuators should be considered active.
mavlink10.SAFETY_SWITCH_STATE_ENUM_END = 2 // 

// ILLUMINATOR_MODE
mavlink10.ILLUMINATOR_MODE_UNKNOWN = 0 // Illuminator mode is not specified/unknown
mavlink10.ILLUMINATOR_MODE_INTERNAL_CONTROL = 1 // Illuminator behavior is controlled by MAV_CMD_DO_ILLUMINATOR_CONFIGURE
                        // settings
mavlink10.ILLUMINATOR_MODE_EXTERNAL_SYNC = 2 // Illuminator behavior is controlled by external factors: e.g. an
                        // external hardware signal
mavlink10.ILLUMINATOR_MODE_ENUM_END = 3 // 

// ILLUMINATOR_ERROR_FLAGS
mavlink10.ILLUMINATOR_ERROR_FLAGS_THERMAL_THROTTLING = 1 // Illuminator thermal throttling error.
mavlink10.ILLUMINATOR_ERROR_FLAGS_OVER_TEMPERATURE_SHUTDOWN = 2 // Illuminator over temperature shutdown error.
mavlink10.ILLUMINATOR_ERROR_FLAGS_THERMISTOR_FAILURE = 4 // Illuminator thermistor failure.
mavlink10.ILLUMINATOR_ERROR_FLAGS_ENUM_END = 5 // 
...
mavlink10.MAV_STANDARD_MODE_ALTITUDE_HOLD = 4 // Altitude hold (manual).           Altitude-controlled and stabilized
                        ...
                        // mode (this may be revisited through the PR
                        // process).
mavlink10.MAV_STANDARD_MODE_SAFE_RECOVERY = 5 // Safe recovery mode (auto).           Automatic mode that takes vehicle
...
mavlink10.MAV_STANDARD_MODE_MISSION = 6 // Mission mode (automatic).           Automatic mode that executes
                        // MAVLink missions.           Missions are
                        // executed from the current waypoint as soon
                        // as the mode is enabled.
mavlink10.MAV_STANDARD_MODE_LAND = 7 // Land mode (auto).           Automatic mode that lands the vehicle at
                        // the current location.           The precise
                        // landing behaviour depends on vehicle
                        // configuration and type.
mavlink10.MAV_STANDARD_MODE_TAKEOFF = 8 // Takeoff mode (auto).           Automatic takeoff mode.           The
                        // precise takeoff behaviour depends on
                        // vehicle configuration and type.
mavlink10.MAV_STANDARD_MODE_ENUM_END = 9 // 
...
mavlink10.MAV_MODE_PROPERTY_NOT_USER_SELECTABLE = 2 // If set, this mode should not be added to the list of selectable modes.
                        ...
                        // failsafe).
mavlink10.MAV_MODE_PROPERTY_AUTO_MODE = 4 // If set, this mode is automatically controlled (it may use but does not
                        // require a manual controller).           If
                        // unset the mode is a assumed to require user
                        // input (be a manual mode).
mavlink10.MAV_MODE_PROPERTY_ENUM_END = 5 // 
...
mavlink10.UAVIONIX_ADSB_OUT_CONTROL_STATE_EXTERNAL_BARO_CROSSCHECKED = 1 // 
mavlink10.UAVIONIX_ADSB_OUT_CONTROL_STATE_ON_GROUND = 4 // 
mavlink10.UAVIONIX_ADSB_OUT_CONTROL_STATE_IDENT_BUTTON_ACTIVE = 8 // 
mavlink10.UAVIONIX_ADSB_OUT_CONTROL_STATE_MODE_A_ENABLED = 16 // 
mavlink10.UAVIONIX_ADSB_OUT_CONTROL_STATE_MODE_C_ENABLED = 32 // 
mavlink10.UAVIONIX_ADSB_OUT_CONTROL_STATE_MODE_S_ENABLED = 64 // 
mavlink10.UAVIONIX_ADSB_OUT_CONTROL_STATE_1090ES_TX_ENABLED = 128 // 
mavlink10.UAVIONIX_ADSB_OUT_CONTROL_STATE_ENUM_END = 129 // 

// UAVIONIX_ADSB_XBIT
mavlink10.UAVIONIX_ADSB_XBIT_ENABLED = 128 // 
mavlink10.UAVIONIX_ADSB_XBIT_ENUM_END = 129 // 

// UAVIONIX_ADSB_OUT_STATUS_STATE
mavlink10.UAVIONIX_ADSB_OUT_STATUS_STATE_ON_GROUND = 1 // 
mavlink10.UAVIONIX_ADSB_OUT_STATUS_STATE_INTERROGATED_SINCE_LAST = 2 // 
mavlink10.UAVIONIX_ADSB_OUT_STATUS_STATE_XBIT_ENABLED = 4 // 
mavlink10.UAVIONIX_ADSB_OUT_STATUS_STATE_IDENT_ACTIVE = 8 // 
mavlink10.UAVIONIX_ADSB_OUT_STATUS_STATE_MODE_A_ENABLED = 16 // 
mavlink10.UAVIONIX_ADSB_OUT_STATUS_STATE_MODE_C_ENABLED = 32 // 
mavlink10.UAVIONIX_ADSB_OUT_STATUS_STATE_MODE_S_ENABLED = 64 // 
mavlink10.UAVIONIX_ADSB_OUT_STATUS_STATE_1090ES_TX_ENABLED = 128 // 
mavlink10.UAVIONIX_ADSB_OUT_STATUS_STATE_ENUM_END = 129 // 

// UAVIONIX_ADSB_OUT_STATUS_NIC_NACP
mavlink10.UAVIONIX_ADSB_NIC_CR_20_NM = 1 // 
mavlink10.UAVIONIX_ADSB_NIC_CR_8_NM = 2 // 
mavlink10.UAVIONIX_ADSB_NIC_CR_4_NM = 3 // 
mavlink10.UAVIONIX_ADSB_NIC_CR_2_NM = 4 // 
mavlink10.UAVIONIX_ADSB_NIC_CR_1_NM = 5 // 
mavlink10.UAVIONIX_ADSB_NIC_CR_0_3_NM = 6 // 
mavlink10.UAVIONIX_ADSB_NIC_CR_0_2_NM = 7 // 
mavlink10.UAVIONIX_ADSB_NIC_CR_0_1_NM = 8 // 
mavlink10.UAVIONIX_ADSB_NIC_CR_75_M = 9 // 
mavlink10.UAVIONIX_ADSB_NIC_CR_25_M = 10 // 
mavlink10.UAVIONIX_ADSB_NIC_CR_7_5_M = 11 // 
mavlink10.UAVIONIX_ADSB_NACP_EPU_10_NM = 16 // 
mavlink10.UAVIONIX_ADSB_NACP_EPU_4_NM = 32 // 
mavlink10.UAVIONIX_ADSB_NACP_EPU_2_NM = 48 // 
mavlink10.UAVIONIX_ADSB_NACP_EPU_1_NM = 64 // 
mavlink10.UAVIONIX_ADSB_NACP_EPU_0_5_NM = 80 // 
mavlink10.UAVIONIX_ADSB_NACP_EPU_0_3_NM = 96 // 
mavlink10.UAVIONIX_ADSB_NACP_EPU_0_1_NM = 112 // 
mavlink10.UAVIONIX_ADSB_NACP_EPU_0_05_NM = 128 // 
mavlink10.UAVIONIX_ADSB_NACP_EPU_30_M = 144 // 
mavlink10.UAVIONIX_ADSB_NACP_EPU_10_M = 160 // 
mavlink10.UAVIONIX_ADSB_NACP_EPU_3_M = 176 // 
mavlink10.UAVIONIX_ADSB_OUT_STATUS_NIC_NACP_ENUM_END = 177 // 

// UAVIONIX_ADSB_OUT_STATUS_FAULT
mavlink10.UAVIONIX_ADSB_OUT_STATUS_FAULT_STATUS_MESSAGE_UNAVAIL = 8 // 
mavlink10.UAVIONIX_ADSB_OUT_STATUS_FAULT_GPS_NO_POS = 16 // 
mavlink10.UAVIONIX_ADSB_OUT_STATUS_FAULT_GPS_UNAVAIL = 32 // 
mavlink10.UAVIONIX_ADSB_OUT_STATUS_FAULT_TX_SYSTEM_FAIL = 64 // 
mavlink10.UAVIONIX_ADSB_OUT_STATUS_FAULT_MAINT_REQ = 128 // 
mavlink10.UAVIONIX_ADSB_OUT_STATUS_FAULT_ENUM_END = 129 // 
...
mavlink10.MAV_TYPE_GENERIC_MULTIROTOR = 43 // Generic multirotor that does not fit into a specific type or whose
                        // type is unknown
mavlink10.MAV_TYPE_ILLUMINATOR = 44 // Illuminator. An illuminator is a light source that is used for
                        // lighting up dark areas external to the
                        // sytstem: e.g. a torch or searchlight (as
                        // opposed to a light source for illuminating
                        // the system itself, e.g. an indicator
                        // light).
mavlink10.MAV_TYPE_ENUM_END = 45 // 
...
mavlink10.MAV_COMP_ID_TUNNEL_NODE = 242 // Component handling TUNNEL messages (e.g. vendor specific GUI of a
                        // component).
mavlink10.MAV_COMP_ID_ILLUMINATOR = 243 // Illuminator
